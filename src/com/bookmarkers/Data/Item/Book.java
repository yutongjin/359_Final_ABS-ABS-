 ...
 * @Description :
 */
public class Book extends IndividualItem{
    Type type;

    public Book(String id, String name, Date dateCreated, boolean active, Date returnDate, User booker, int[] cost, List<String> keyWord) {
